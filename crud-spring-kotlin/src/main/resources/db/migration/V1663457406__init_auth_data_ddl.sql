...
('ORDER_READ', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('ORDER_WRITE', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('ORDER_DELETE', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
